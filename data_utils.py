...
def get_wmt_enfr_train_set(directory):
  ...
  print("get_wmt_enfr_train_set\n")
  print("Trainpath is {}".format(train_path))
  #SHANKAR
  return train_path
...
def get_wmt_enfr_dev_set(directory):
  """Download the WMT en-fr training corpus to directory unless it's there."""
  print("get_wmt_enfr_dev_set\n")
  dev_name = "newstest2013"
  dev_path = os.path.join(directory, dev_name)
  print("Dev path is {}".format(dev_path))
  #SHANKAR
  return dev_path
...
def prepare_data(data_dir, from_train_path, to_train_path, from_dev_path, to_dev_path, from_vocabulary_size,
  ...
  """Preapre all necessary files that are required for the training.
    ...
    """
  print("prepare_data\n")
  print(to_vocabulary_size)
  print(from_vocabulary_size)
  ...
  to_train_ids_path = to_train_path
  from_train_ids_path = from_train_path
  ...
  to_dev_ids_path = to_dev_path
  from_dev_ids_path = from_dev_path
